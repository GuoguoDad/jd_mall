...
import kotlinx.android.synthetic.main.five_memu_gridview.*

class GridFragment(data: MutableList<MenuBean>, index: Int, pageSize: Int):  BaseFragment(R.layout.five_memu_gridview) {
